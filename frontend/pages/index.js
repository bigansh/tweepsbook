	...
	render() {
		return (
			<>
				...
				<div className='w-full h-full absolute top-0 left-0 z-9999 flex items-center justify-center overflow-hidden backdrop-blur-sm'>
					<Player
						className='flex flex-col bg-white shadow-xl z-100  w-4/5 rounded-xl p-2 sm:p-12 overflow-y-scroll h-4/5 border-4 border-cyan-400'
