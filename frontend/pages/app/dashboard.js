		...
		<div className='overflow-hidden'>
			<div className='flex items-center justify-around h-24 border'>
				...
				<div className='flex items-center justify-center'>
					<img src='https://pbs.twimg.com/profile_images/1541300431623598080/QNrH1wh1_400x400.jpg' className='w-12 h-12 m-1 rounded-full' />
					<button className="m-1 p-1" onClick={menuClick}><AiOutlineDown /></button>
				{menuActive && <div className='flex flex-col relative top-16 w-32 z-10 bg-white'>
					<button ><BiLogOut />Logout</button>
					<button ><BiLogOut />Settings</button>
				</div>}
				</div>
