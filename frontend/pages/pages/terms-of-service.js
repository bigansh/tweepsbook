		...
		<div className='w-full h-full absolute top-0 left-0 bg-sh-gray bg-opacity-80 z-50 flex items-center justify-center overflow-hidden backdrop-blur-sm'>
			...
			<div className='flex flex-col shadow-xl w-4/5 rounded p-4 sm:p-32 overflow-y-scroll h-4/5 border-4 border-cyan-400 border-xl flow'>
				<h1 className=' text-3xl text-[#004964] font-bold text-center mb-11 items-center flex justify-between'>
					...
					Terms of Service
					<AiOutlineClose
						className='icon-grey ml-2 cursor-pointer '
						size={30}
						onClick={() => {
				...
				<p className='text-lg text-gray-600 leading-8'>
					...
					<p className='text-md text-gray-600 leading-8'>
						...
						refers to you, the person who logs on to this website
						and is compliant with the Company’s terms and
						...
						Company’s stated services, by and subject to, prevailing
						law of Netherlands. Any use of the above terminology or
					...
					<p className='text-md text-gray-600 leading-8'>
						...
						website. Comments do not reflect the views and opinions
						ofTweepsBook, its agents, and/or affiliates. Comments
						reflect the views and opinions of the person who posts
						their views and opinions. To the extent permitted by
						applicable laws, TweepsBook shall not be liable for the
					...
					<li>
						...
						have all necessary licenses and consent to do so
					</li>
					<li>
					...
					<li>
						...
						business or custom or present commercial or unlawful
						activity
					</li>
					...
					<li>
						...
						charity fundraising groups may not hyperlink to our
						Website.
					</li>
					...
					<li>
						...
						compensates for the absence of TweepsBook
					</li>
					<li>
					...
					<p className='text-md text-gray-600 leading-8'>
						...
						Please include your name, organization name, contact
					...
					<li>
						Using any other description of our Website being linked
						to makes sense within the context and format of content
					...
					<p className='text-md text-gray-600 leading-8'>
						...
						Website that may be interpreted as libelous, obscene, or
					...
					<p className='text-md text-gray-600 leading-8'>
						...
						available or that its material is kept up to date.
					</p>
					<br />
